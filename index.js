...
function viajeElegido(eleccionViajes){
    while(eleccionViajes != 1 || eleccionViajes != 2 || eleccionViajes != 3 || eleccionViajes != 4){
        if(eleccionViajes == 1){
            ...
            return alert("Eligio el viaje a miami. Con un valor de " + precioBrasil + " pesos");

        }else if(eleccionViajes == 3) {
            return alert("Eligio el viaje a miami. Con un valor de " + precioAustralia + " pesos");

        }else if(eleccionViajes == 4) {
            return alert("Eligio el viaje a miami. Con un valor de " + precioEspaña + " pesos");
        }
...
cantidad = parseInt(prompt("Ingrese la cantidad de viajes que desea comprar"));
